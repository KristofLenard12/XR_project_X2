...
namespace Coherence.Generated
{
	...
	public struct FloorPlane_id0_UnityEngine__char_46_MeshCollider_124998048203007390 : ICoherenceComponentData
	{
		public bool convex;
		...
		{
			return $"FloorPlane_id0_UnityEngine__char_46_MeshCollider_124998048203007390(convex: {convex}, skinWidth: {skinWidth}, inflateMesh: {inflateMesh}, enabled: {enabled}, isTrigger: {isTrigger}, contactOffset: {contactOffset}, hasModifiableContacts: {hasModifiableContacts})";
		}

		public uint GetComponentType() => Definition.InternalFloorPlane_id0_UnityEngine__char_46_MeshCollider_124998048203007390;
		...
		{
			var other = (FloorPlane_id0_UnityEngine__char_46_MeshCollider_124998048203007390)data;
			if ((mask & 0x01) != 0)
			{
				Frame = other.Frame;
				convex = other.convex;
		...
		{
			uint mask = 0;
			var newData = (FloorPlane_id0_UnityEngine__char_46_MeshCollider_124998048203007390)data;
		...
		public static void Serialize(FloorPlane_id0_UnityEngine__char_46_MeshCollider_124998048203007390 data, uint mask, IOutProtocolBitStream bitStream)
		{
		...
		public static (FloorPlane_id0_UnityEngine__char_46_MeshCollider_124998048203007390, uint, uint?) Deserialize(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new FloorPlane_id0_UnityEngine__char_46_MeshCollider_124998048203007390();
		...
		public static (FloorPlane_id0_UnityEngine__char_46_MeshCollider_124998048203007390, uint, uint?) DeserializeArchetypeFloorPlane_8eb27a8d75b38914780fb01a3d8b2d6a_FloorPlane_id0_UnityEngine__char_46_MeshCollider_124998048203007390_LOD0(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new FloorPlane_id0_UnityEngine__char_46_MeshCollider_124998048203007390();
			if (bitStream.ReadMask())
		...
		{
			var last = lastSent as FloorPlane_id0_UnityEngine__char_46_MeshCollider_124998048203007390?;
		}
	}
}