...
namespace Coherence.Generated
{
	...
	public struct GenericScale : ICoherenceComponentData
	{
		...
		public static (GenericScale, uint, uint?) DeserializeArchetypeFloorPlane_8eb27a8d75b38914780fb01a3d8b2d6a_GenericScale_LOD0(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new GenericScale();
			if (bitStream.ReadMask())
		...
		public static (GenericScale, uint, uint?) DeserializeArchetypeAirHockeyTable_1b8979aab75cc3548ac0742146ec7eed_GenericScale_LOD0(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new GenericScale();
			if (bitStream.ReadMask())
		...
		public static (GenericScale, uint, uint?) DeserializeArchetypePuck_67d153e8cb5779a49a2e569ee35a4437_GenericScale_LOD0(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new GenericScale();
			if (bitStream.ReadMask())
		...
		public static (GenericScale, uint, uint?) DeserializeArchetypeMallet_38e627b1eb339e74eb512bd8e1020e39_GenericScale_LOD0(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new GenericScale();
			if (bitStream.ReadMask())
