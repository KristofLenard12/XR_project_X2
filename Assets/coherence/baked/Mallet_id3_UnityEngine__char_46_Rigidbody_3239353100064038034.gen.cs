...
namespace Coherence.Generated
{
	...
	public struct Mallet_id3_UnityEngine__char_46_Rigidbody_3239353100064038034 : ICoherenceComponentData
	{
		...
		{
			return $"Mallet_id3_UnityEngine__char_46_Rigidbody_3239353100064038034(velocity: {velocity}, angularVelocity: {angularVelocity}, drag: {drag}, angularDrag: {angularDrag}, mass: {mass}, useGravity: {useGravity}, maxDepenetrationVelocity: {maxDepenetrationVelocity}, isKinematic: {isKinematic}, freezeRotation: {freezeRotation}, centerOfMass: {centerOfMass}, inertiaTensorRotation: {inertiaTensorRotation}, inertiaTensor: {inertiaTensor}, detectCollisions: {detectCollisions}, position: {position}, rotation: {rotation}, solverIterations: {solverIterations}, sleepThreshold: {sleepThreshold}, maxAngularVelocity: {maxAngularVelocity}, solverVelocityIterations: {solverVelocityIterations}, solverIterationCount: {solverIterationCount}, solverVelocityIterationCount: {solverVelocityIterationCount})";
		}

		public uint GetComponentType() => Definition.InternalMallet_id3_UnityEngine__char_46_Rigidbody_3239353100064038034;
		...
		{
			var other = (Mallet_id3_UnityEngine__char_46_Rigidbody_3239353100064038034)data;
			if ((mask & 0x01) != 0)
			{
				Frame = other.Frame;
		...
		{
			uint mask = 0;
			var newData = (Mallet_id3_UnityEngine__char_46_Rigidbody_3239353100064038034)data;
		...
		public static void Serialize(Mallet_id3_UnityEngine__char_46_Rigidbody_3239353100064038034 data, uint mask, IOutProtocolBitStream bitStream)
		{
			...
			if (bitStream.WriteMask((mask & 0x01) != 0))
			{
				Coherence.Utils.Bounds.Check(data.solverIterations, _solverIterations_Min, _solverIterations_Max, "Mallet_id3_UnityEngine__char_46_Rigidbody_3239353100064038034.solverIterations");
			...
			if (bitStream.WriteMask((mask & 0x01) != 0))
			{
				Coherence.Utils.Bounds.Check(data.solverVelocityIterations, _solverVelocityIterations_Min, _solverVelocityIterations_Max, "Mallet_id3_UnityEngine__char_46_Rigidbody_3239353100064038034.solverVelocityIterations");
			...
			if (bitStream.WriteMask((mask & 0x01) != 0))
			{
				Coherence.Utils.Bounds.Check(data.solverIterationCount, _solverIterationCount_Min, _solverIterationCount_Max, "Mallet_id3_UnityEngine__char_46_Rigidbody_3239353100064038034.solverIterationCount");
			...
			if (bitStream.WriteMask((mask & 0x01) != 0))
			{
				Coherence.Utils.Bounds.Check(data.solverVelocityIterationCount, _solverVelocityIterationCount_Min, _solverVelocityIterationCount_Max, "Mallet_id3_UnityEngine__char_46_Rigidbody_3239353100064038034.solverVelocityIterationCount");
		...
		public static (Mallet_id3_UnityEngine__char_46_Rigidbody_3239353100064038034, uint, uint?) Deserialize(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new Mallet_id3_UnityEngine__char_46_Rigidbody_3239353100064038034();
		...
		public static (Mallet_id3_UnityEngine__char_46_Rigidbody_3239353100064038034, uint, uint?) DeserializeArchetypeMallet_38e627b1eb339e74eb512bd8e1020e39_Mallet_id3_UnityEngine__char_46_Rigidbody_3239353100064038034_LOD0(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new Mallet_id3_UnityEngine__char_46_Rigidbody_3239353100064038034();
			if (bitStream.ReadMask())
		...
		{
			var last = lastSent as Mallet_id3_UnityEngine__char_46_Rigidbody_3239353100064038034?;
		}
	}
}