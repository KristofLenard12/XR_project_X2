...
namespace Coherence.Generated
{
	...
	public struct AirHockeyTable_id1_UnityEngine__char_46_Rigidbody_8131950279819150428 : ICoherenceComponentData
	{
		...
		{
			return $"AirHockeyTable_id1_UnityEngine__char_46_Rigidbody_8131950279819150428(velocity: {velocity}, angularVelocity: {angularVelocity}, drag: {drag}, angularDrag: {angularDrag}, mass: {mass}, useGravity: {useGravity}, maxDepenetrationVelocity: {maxDepenetrationVelocity}, isKinematic: {isKinematic}, freezeRotation: {freezeRotation}, centerOfMass: {centerOfMass}, inertiaTensorRotation: {inertiaTensorRotation}, inertiaTensor: {inertiaTensor}, detectCollisions: {detectCollisions}, position: {position}, rotation: {rotation}, solverIterations: {solverIterations}, sleepThreshold: {sleepThreshold}, maxAngularVelocity: {maxAngularVelocity}, solverVelocityIterations: {solverVelocityIterations}, solverIterationCount: {solverIterationCount}, solverVelocityIterationCount: {solverVelocityIterationCount})";
		}

		public uint GetComponentType() => Definition.InternalAirHockeyTable_id1_UnityEngine__char_46_Rigidbody_8131950279819150428;
		...
		{
			var other = (AirHockeyTable_id1_UnityEngine__char_46_Rigidbody_8131950279819150428)data;
			if ((mask & 0x01) != 0)
			{
				Frame = other.Frame;
		...
		{
			uint mask = 0;
			var newData = (AirHockeyTable_id1_UnityEngine__char_46_Rigidbody_8131950279819150428)data;
		...
		public static void Serialize(AirHockeyTable_id1_UnityEngine__char_46_Rigidbody_8131950279819150428 data, uint mask, IOutProtocolBitStream bitStream)
		{
			...
			if (bitStream.WriteMask((mask & 0x01) != 0))
			{
				Coherence.Utils.Bounds.Check(data.solverIterations, _solverIterations_Min, _solverIterations_Max, "AirHockeyTable_id1_UnityEngine__char_46_Rigidbody_8131950279819150428.solverIterations");
			...
			if (bitStream.WriteMask((mask & 0x01) != 0))
			{
				Coherence.Utils.Bounds.Check(data.solverVelocityIterations, _solverVelocityIterations_Min, _solverVelocityIterations_Max, "AirHockeyTable_id1_UnityEngine__char_46_Rigidbody_8131950279819150428.solverVelocityIterations");
			...
			if (bitStream.WriteMask((mask & 0x01) != 0))
			{
				Coherence.Utils.Bounds.Check(data.solverIterationCount, _solverIterationCount_Min, _solverIterationCount_Max, "AirHockeyTable_id1_UnityEngine__char_46_Rigidbody_8131950279819150428.solverIterationCount");
			...
			if (bitStream.WriteMask((mask & 0x01) != 0))
			{
				Coherence.Utils.Bounds.Check(data.solverVelocityIterationCount, _solverVelocityIterationCount_Min, _solverVelocityIterationCount_Max, "AirHockeyTable_id1_UnityEngine__char_46_Rigidbody_8131950279819150428.solverVelocityIterationCount");
		...
		public static (AirHockeyTable_id1_UnityEngine__char_46_Rigidbody_8131950279819150428, uint, uint?) Deserialize(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new AirHockeyTable_id1_UnityEngine__char_46_Rigidbody_8131950279819150428();
		...
		public static (AirHockeyTable_id1_UnityEngine__char_46_Rigidbody_8131950279819150428, uint, uint?) DeserializeArchetypeAirHockeyTable_1b8979aab75cc3548ac0742146ec7eed_AirHockeyTable_id1_UnityEngine__char_46_Rigidbody_8131950279819150428_LOD0(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new AirHockeyTable_id1_UnityEngine__char_46_Rigidbody_8131950279819150428();
			if (bitStream.ReadMask())
		...
		{
			var last = lastSent as AirHockeyTable_id1_UnityEngine__char_46_Rigidbody_8131950279819150428?;
		}
	}
}